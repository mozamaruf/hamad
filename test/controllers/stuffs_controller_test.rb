...
class StuffsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stuff" do
    assert_difference('Stuff.count') do
      post stuffs_url, params: { stuff: { description: @stuff.description, location: @stuff.location, name: @stuff.name, price: @stuff.price } }
    end
  ...
  test "should update stuff" do
    patch stuff_url(@stuff), params: { stuff: { description: @stuff.description, location: @stuff.location, name: @stuff.name, price: @stuff.price } }
