...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { description: @tool.description, price: @tool.price, tname: @tool.tname, toolid: @tool.toolid } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { description: @tool.description, price: @tool.price, tname: @tool.tname, toolid: @tool.toolid } }
